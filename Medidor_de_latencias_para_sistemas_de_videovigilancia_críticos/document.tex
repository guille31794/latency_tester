...
La ejecución sobre Linux (Ubuntu 24.04, GCC 13, Qt 6.11.1) con AddressSanitizer habilitado produce los mismos 147 tests pasados con 2 skipped. El informe de ASan al finalizar indica:
...
\begin{tabular}{|p{4cm}|p{3.5cm}|p{2cm}|p{3.5cm}|}
\hline
...
\begin{enumerate}
    \item \textbf{Pruebas unitarias} (QTest): 147 tests automatizados distribuidos en 10 suites, cubriendo la totalidad de los módulos Core y GUI. Todos los tests pasan satisfactoriamente en los tres entornos de compilación (Windows x86\_64, Linux x86\_64, ARM64 emulado).
...
El software desarrollado resuelve un problema real en el ámbito de la videovigilancia para sistemas críticos. En entornos donde la respuesta del operador depende directamente de la latencia del sistema de vídeo — salas de control de infraestructuras críticas, centros de vigilancia penitenciaria, control fronterizo — no existía hasta ahora un instrumento portátil, económico y autónomo capaz de cuantificar ese retardo de forma objetiva y repetible. El dispositivo propuesto llena ese vacío con una solución que combina hardware de bajo coste (Raspberry Pi, LED, fotosensor ADC) con un software embebido que proporciona:
...
\begin{itemize}
    ...
    \item Verificación exhaustiva mediante 147 pruebas unitarias automatizadas, análisis de memoria con AddressSanitizer y Valgrind, y validación gráfica sobre la resolución real del dispositivo.
\end{itemize}
