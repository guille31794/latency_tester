...
public:
    ...
    void setupUi(QMainWindow *StartScreen)
    {
        ...
        StartScreen->setMinimumSize(QSize(800, 600));
        StartScreen->setMaximumSize(QSize(800, 600));
...
""));
        ...
        verticalLayoutWidget_2->setGeometry(QRect(210, 50, 391, 461));
        ...
        generalInfoFrame->setGeometry(QRect(0, 0, 800, 600));
        sizePolicy.setHeightForWidth(generalInfoFrame->sizePolicy().hasHeightForWidth());
        generalInfoFrame->setSizePolicy(sizePolicy);
        generalInfoFrame->setMinimumSize(QSize(800, 600));
        generalInfoFrame->setMaximumSize(QSize(800, 600));
        ...
        generalInfoText->setGeometry(QRect(230, 110, 311, 341));
        QFont font;
        ...
        settingsFrame->setGeometry(QRect(0, 0, 800, 600));
        sizePolicy.setHeightForWidth(settingsFrame->sizePolicy().hasHeightForWidth());
        settingsFrame->setSizePolicy(sizePolicy);
        settingsFrame->setMinimumSize(QSize(800, 600));
        settingsFrame->setMaximumSize(QSize(800, 600));
        ...
        verticalLayoutWidget_3->setGeometry(QRect(170, 100, 481, 411));
        ...
        registryFrame->setGeometry(QRect(0, 0, 800, 600));
        sizePolicy.setHeightForWidth(registryFrame->sizePolicy().hasHeightForWidth());
        registryFrame->setSizePolicy(sizePolicy);
        registryFrame->setMinimumSize(QSize(800, 600));
        registryFrame->setMaximumSize(QSize(800, 600));
        ...
        registryTreeView->setGeometry(QRect(120, 90, 581, 391));
        ...
        registryButtonsBox->setGeometry(QRect(119, 500, 581, 80));
        ...
        startFrame->setGeometry(QRect(0, 0, 800, 600));
        sizePolicy.setHeightForWidth(startFrame->sizePolicy().hasHeightForWidth());
        startFrame->setSizePolicy(sizePolicy);
        startFrame->setMinimumSize(QSize(800, 600));
        startFrame->setMaximumSize(QSize(800, 600));
        ...
        verticalLayoutWidget->setGeometry(QRect(190, 60, 391, 461));
...
"color: rgb(0, 0, 0);"));
        ...
        registryDisplayerFrame->setGeometry(QRect(0, 0, 800, 600));
        ...
        registryDisplayerFrame->setMinimumSize(QSize(800, 600));
        registryDisplayerFrame->setMaximumSize(QSize(800, 600));
        ...
        formLayoutWidget_2->setGeometry(QRect(450, 427, 321, 141));
        ...
        formLayoutWidget_3->setGeometry(QRect(25, 427, 331, 141));
        ...
        startMeasureFrame->setGeometry(QRect(0, 0, 800, 600));
        sizePolicy.setHeightForWidth(startMeasureFrame->sizePolicy().hasHeightForWidth());
        startMeasureFrame->setSizePolicy(sizePolicy);
        startMeasureFrame->setMinimumSize(QSize(800, 600));
        startMeasureFrame->setMaximumSize(QSize(800, 600));
        ...
        verticalLayoutWidget_4->setGeometry(QRect(40, 390, 302, 181));
        ...
        verticalLayoutWidget_5->setGeometry(QRect(480, 390, 302, 181));
        ...
        stopMeasureButton->setGeometry(QRect(370, 520, 80, 25));
        plotMeasures = new QCustomPlot(startWidget);
        plotMeasures->setObjectName(QString::fromUtf8("plotMeasures"));
        plotMeasures->setGeometry(QRect(80, 80, 681, 291));
